...
public class AllResultsDialog extends JDialog {
  ...
  public AllResultsDialog(JFrame parent, double[] percentages, String[] suggestions) {
  ...
  public static void main(String [] args) {
    double[] percentages = {25,30,75};
    String[] suggestions = {"CS 240", "Math 225", "ARTS 301"};
    JFrame frame = new JFrame("All Results");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    AllResultsDialog test = new AllResultsDialog(frame, percentages, suggestions);
    frame.pack();
