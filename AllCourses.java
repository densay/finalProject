...
public class AllCourses extends JPanel {
  ...
  public AllCourses(String one, String two, String three) {
    ...
    question1 = new JLabel("How many 100 level classes have you taken?");
    question2 = new JLabel("How many 200 level classes have you taken?", question2.CENTER);
    question3 = new JLabel("How many 300 level classes have you taken?", question3.CENTER);
    questionPanel.add(question1, BorderLayout.LINE_START);
